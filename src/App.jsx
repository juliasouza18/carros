    ...
    <main className="min-h-svh bg-offwhitebg py-20 px-6 antialiased lg:flex justify-center items-center">
      <section className="lg:flex max-w-[920px]">
        <div className="bg-orange p-12  max rounded-t-lg lg:rounded-l-lg">
          ...
          <p className="font-lexend mb-7 text-offwhite lg:mb-20">Escolha um sedan pelo seu preço acessível e excelente economia de 
            combustível. Ideal para dirigir na cidade ou na sua próxima viagem.</p>
        ...
        <div className="bg-green p-12 antialiased">
        ...
        <div className="bg-dark-green p-12 max-lg:rounded-b-lg lg:rounded-r-lg antialiased">
